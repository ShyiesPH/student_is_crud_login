...
include("auth_session.php");
    ...
    echo '<script>alert("Student has updated added.")</script>';
                    ...
                    <div class="card">
                        ...
                        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="name" class="form-control" value="<?php echo $row["name"]; ?>" maxlength="50" placeholder="Enter your Name" name="name">
                                    </div>
                                </div>
                                <label for="email_address">Email Address</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="email" id="email_address" class="form-control" value="<?php echo $row["email"]; ?>" maxlength="30"  placeholder="Enter your email address" name="email">
                                    </div>
                                </div>
                                <label for="mobile">Mobile Number</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="mobile" id="mobile" class="form-control" value="<?php echo $row["mobile"]; ?>" maxlength="12" placeholder="Enter your Number" name="mobile">
                                    </div>
                                </div>
